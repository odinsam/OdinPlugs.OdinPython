...
using OdinPlugs.OdinPython.Test.dbContext;
using Xunit;

namespace OdinPlugs.OdinPython.Test
{
    public class UnitTestPythonExpression
    {
        /// <summary>
        ...
        /// <returns></returns>
        [Fact]
        public void InvokerCustomScript()
        {
            IOdinPythonDotNet pythonDotNet = GetPythonDotNetEngine();
            var pyStr = "def OdinPythonCustomInvoker(str):\r\n\tprint (str)\r\n\treturn 'result'";
            string result = pythonDotNet.InvokerCustomScript(pyStr, "OdinPythonCustomInvoker", "param");
